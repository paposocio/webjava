...
public class UserRepositoryImpl implements Repository<User> {
    ...
    public List<User> listAllObj() throws SQLException {
        sql = "select user_id, user_firstname, user_lastname, user_email, user_password " +
                "from users_tbl order by user_firstname,user_lastname;";
    ...
    public Integer saveObj(User user) throws SQLException
    {
        ...
        if(user.getUser_id() != null && user.getUser_id() > 0)
        {
            sql = "update users_tbl set user_firstname = ?, user_lastname = ?, user_email = ?," +
                    " user_password = aes_encrypt(?, '$2a$12$h.dl7n64P0qaGYnQfKgCSuzVKrh3q3p9xkZ/VxR6NtnN7Lud6of.u')" +
                    ", where user_id = ?";
        }
        else
        {
            sql = "insert into users_tbl (user_firstname, user_lastname, user_email, user_password) " +
                    ...
                    "aes_encrypt(?,'$2a$12$h.dl7n64P0qaGYnQfKgCSuzVKrh3q3p9xkZ/VxR6NtnN7Lud6of.u'));";
        }
