...
<body>
    ...
    <section class="loginContainer">
        <h1 class="text-secondary">Registro Productos</h1>
        <form class="row g-3" action="${pageContext.request.contextPath}/register-product" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="0" class="form-control" name="productValue" id="exampleFormControlInput2"
                    required>
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput3" class="form-label">Numero de la categoria</label>
                <input type="number" min="0" class="form-control" name="categoryId" id="exampleFormControlInput3"
                    required>
            </div>
